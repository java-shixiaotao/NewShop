...
<div class="sjsc-title2">
    ...
    <a href="conversionList.html?gift_id=${gift_id}" class="sjsc-t2r"><img src="images/back.png" alt=""
                                                                           style="width:20px;height: 20px;padding-top: 11px;padding-left: 5px"/></a>
</div>
<c:forEach items="${list }" var="list" varStatus="s">
    <dl class="drdd-info7">
        <a href="conversionList.html?addr_id=${list.addr_id}&gift_id=${gift_id}">
            <dt>
                <p>
                ...
                <p><c:if test="${s.count==1}">
                    <span style="color: #f60">[默认]</span></c:if>${list.addr_name}
                </p>
            </dt>
        </a>
        <dd><a href="#">></a></dd>
