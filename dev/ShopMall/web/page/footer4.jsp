...
<ul class="quanbu-ul1">
    ...
    <li>
        <div class="qu-tu1" style="height: 43px;" align="center">
            ...
            <span style="position:fixed;margin-top: -45px;margin-left:16px;color: #ff3c00"
                  id="cart_num">${cart_num }</span>
        </div>
    ...
    <li>
        <div class="qu-tu1" align="center">
            ...
            <a href="orderList.html" class="atu2"><img src="images/ord-1.png" style="width: 22px;height: 22px"></a>
        </div>
