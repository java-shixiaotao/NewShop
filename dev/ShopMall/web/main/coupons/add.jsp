...
<body>
				...
				<div class="row cl">
						...
						<div class="formControls col-10">
							<input type="text" id="cps_price"
								placeholder="请填写券额" value="" class="input-text" style="width: 80%">
						</div>
			</div><br>
					<div class="row cl">
						...
						<div class="formControls col-10">
							<input type="text" id="cps_time" onfocus="WdatePicker()" class="input-text Wdate"
								placeholder="请填写截止时间" value="" class="input-text" style="width: 80%">
						</div>
			</div>
					<br><br>
	...
	function add(){
		...
		$.ajax({
			url:'cpsInsert.html',
			type:'post',
			data:'cps_name='+encodeURI(cps_name)+'&cps_price='+cps_price+'&cps_time='+cps_time,
			success:function(rs){
				if(rs==1){
