...
<body>
	<nav class="breadcrumb">
		...
		区域查看 <a class="btn btn-success radius r mr-20"
	...
	<!--  
	<div class="text-c">
				<input type="text" value="${receive_name}" 
					id="receive_name"  class="input-text"
					style="width: 140px;" placeholder="请输入姓名"> 
			<input type="text" value="${school}" 
					id="school"  class="input-text"
					style="width: 140px;" placeholder="请输入学校"> 		
			<input type="text" value="${id_card}" 
					id="id_card"  class="input-text"
					style="width: 140px;" placeholder="请输入身份证号码">  
				<input type="text" value="${payment_time}" 
					id="payment_time"  class="input-text"
					style="width: 140px;" placeholder="请输入还款日">
			...
			<script type="text/javascript">
				function search() {
					...
					window.location.href = 'ordList?receive_name=' + encodeURIComponent(encodeURIComponent(receive_name))
