...
<body>
    ...
    <div class="sjsc-title2">
        ...
        <a href="membershipindex.html?addr_id=${addr_id}" class="sjsc-t2r"><img src="images/back.png" alt="" style="width:20px;height: 20px;padding-top: 11px;padding-left: 5px"/></a>
    </div>
    <c:forEach items="${list }" var="list" varStatus="s">
    <dl class="drdd-info7">
    <a href="membershipindex.html?addr_id=${list.addr_id}">
    	<dt>
        	<p>
