...
<body>
	...
	<div class="pd-20" style="width: 80%">
			...
			<div class="row cl">
						...
						<div class="formControls col-10">
						<select id="ctg_id" class="input-text" style="width: 80%">
						
						<c:forEach items="${category}" var="ctg">
						<c:if test="${list.ctg_id==ctg.ctg_id}"><option value="${ctg.ctg_id}">${ctg.ctg_name }</option></c:if>
						</c:forEach>
						<c:forEach items="${category}" var="ctg">
						<c:if test="${list.ctg_id!=ctg.ctg_id}"><option value="${ctg.ctg_id}">${ctg.ctg_name }</option></c:if>
						</c:forEach>
			...
			<div class="row cl">
						...
						<div class="formControls col-10">
							<textarea name="content" id="goods_detail" style="width: 80%;height: 260px;"></textarea>
						</div>
			</div><br>	
					<br>
