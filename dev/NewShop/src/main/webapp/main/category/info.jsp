...
<body>
	...
	<div class="pd-20" style="width: 80%">
			...
			<div class="row cl"><input id="ctg_id" type="hidden" value="${list.ctg_id }">
						<label class="form-label col-2">名称：</label>
						<div class="formControls col-10">
							<input type="text" id="ctg_name"
								placeholder="请填写名称" value="${list.ctg_name}" class="input-text" style="width: 80%">
						</div>
			</div><br>
			<div class="row cl">
				...
				<div class="row cl">
						...
						<div class="formControls col-10" id="img">
							<img alt="" src="${list.ctg_img}" width="100" height="100">
						</div>
				</div>
				</c:forEach>	
					<br><br>
	...
	function add(){
		...
		$.ajax({
			url:'ctgUpdate',
			type:'post',
			data:'ctg_name='+encodeURI(ctg_name)+'&ctg_img='+ctg_img+'&ctg_id='+ctg_id,
			success:function(rs){
				if(rs==1){
