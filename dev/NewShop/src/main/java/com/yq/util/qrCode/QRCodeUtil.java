...
public final class QRCodeUtil extends LuminanceSource {
     ...
     * @throws Exception
     */
    public  static String generateQRCode(String text, int width, int height, String format,String filepath, String pathName)
            throws Exception {
        ...
        BitMatrix bitMatrix = new MultiFormatWriter().encode(text, BarcodeFormat.QR_CODE, width, height, hints);         //目的
